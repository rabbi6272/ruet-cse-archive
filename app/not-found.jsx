    ...
    const timer = setTimeout(
      () => {
        if (currentCharIndex < currentLine.text.length) {
          setTerminalText(
            (prev) => prev + currentLine.text.charAt(currentCharIndex),
          );
    ...
    <>
      ...
      >
        <div className="fade-in-container text-center p-4 max-w-[90vw] w-full">
          ...
          <div
            className="max-w-[90vw] w-full mx-auto mb-8 bg-gray-900 bg-opacity-60 border border-gray-700 rounded-xl p-6 text-left backdrop-blur-sm shadow-2xl overflow-hidden"
