    ...
    return (
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">Please login to view your notifications</p>
          <a 
            href="/user/login" 
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400">
                              ...
                              <span>
                                <i className={`fas fa-circle mr-1 ${notification.type === 'comment' ? 'text-green-500' : notification.type === 'reply' ? 'text-blue-500' : 'text-purple-500'}`}></i>
                                {notification.type}
                              </span>
                              {!notification.read && (
                                <span className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200">
                                  <i className="fas fa-circle text-blue-500 mr-1" style={{fontSize: '6px'}}></i>
                                  New
                                </span>
                              )}
                            </div>
