...
import { ProfileCard } from "@/components/contact/developers/profileCard";
import {
...
export default function Developers() {
      ...
      <div className="p-4 md:p-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">Loading development team...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="p-4 md:p-8">
      {/* Error Alert */}
      {error && (
        <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 text-yellow-800 dark:text-yellow-200 px-4 py-3 rounded">
          <div className="flex items-center">
            <span className="text-yellow-500 dark:text-yellow-400 mr-2">⚠️</span>
            <span>
