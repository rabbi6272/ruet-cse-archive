...
export default function AddAlumni() {
  ...
  const handlePasswordSubmit = () => {
    if (passwordInput === ADMIN_PASSWORD) {
      ...
      setMessage({
        type: "success",
        text: "Access granted! You can now add alumni.",
      });
    } else {
      setMessage({
        type: "error",
  ...
  const handleBadgeChange = (badge, checked) => {
    const currentBadges = formData.badges
      ? formData.badges.split(",").filter((b) => b.trim())
      : [];
  ...
  const validateForm = () => {
    ...
    if (!formData.coordinates[0] || !formData.coordinates[1]) {
      setMessage({
        type: "error",
        text: "Both longitude and latitude coordinates are required",
      });
      return false;
    }
    ...
    if (
      ...
      setMessage({
        type: "error",
        text: "Coordinates must be within valid ranges (Longitude: -180 to 180, Latitude: -90 to 90)",
      });
      return false;
    }
        ...
        <div className="min-h-screen  flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
            ...
            <div className="mt-6 text-xs text-gray-500 text-center">
              <p>
                Enter the admin password to access the alumni management system.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You are not authorized to add alumni. Only specific administrators
          ...
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Add a new alumni to the global network map
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-xs text-gray-500 bg-blue-50 p-3 rounded">
                  💡 <strong>Tip:</strong> You can find coordinates using Google
                  Maps - right-click on a location and select "What's here?" to
                  get the coordinates.
                </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 bg-blue-50 rounded-lg p-4">
              ...
              <p className="text-xs text-blue-700">
                There are also {existingAlumni.length > 0 ? "40+" : "40"} alumni
                in the static data file. New alumni added here will appear
                alongside them on the map.
              </p>
            </div>
          </div>
        </div>
