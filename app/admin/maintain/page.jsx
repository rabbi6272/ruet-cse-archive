      ...
      if (resource.id === resourceId) {
        const updatedSemesters = resource.semesters.map((semester) => {
          if (semester.id === semesterId) {
            const existingLinksCount = semester.links.filter(
              (l) => l.url
            ).length;
        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Enter the admin password to access the maintenance panel
            </p>
          </div>
          ...
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Manage drive links for resources page
              </p>
            </div>
                    ...
                    <div className="flex gap-2">
                      {link.url && (
                        <button
                          onClick={() =>
                            setEditingLink(
                              `${resource.id}-${semester.id}-${link.label}`
                            )
                          }
                      ...
                      {link.url && (
                        <button
                          onClick={() =>
                            onDeleteLink(resource.id, semester.id, link.label)
                          }
