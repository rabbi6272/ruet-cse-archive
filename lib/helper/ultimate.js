...
const custom_config = {
  ...
  databaseURL: "https://cse-archive-utilities-default-rtdb.europe-west1.firebasedatabase.app",
...
const pc_config = {
    ...
    databaseURL: "https://cse-archive-p2p-default-rtdb.asia-southeast1.firebasedatabase.app",
...
const ac_config = {
  ...
  databaseURL: "https://cse-archive-pikachu-default-rtdb.europe-west1.firebasedatabase.app",
...
const doubts_config = {
  ...
  databaseURL: "https://cse-archive-doubts-default-rtdb.europe-west1.firebasedatabase.app",
...
class CodeSnippet{
    ...
    async push() {
    try {
      const dbRef = ref(this.db,"codes/"+this.obj.roll);
      await set(dbRef, this.obj);
      console.log(`Data inserted successfully.`);
...
export {AssistantMessage,CodeSnippet,CustomBuilder,GroupMessage,PersonalMessage,DoubtsHelp,Notification,Presence,NutrinoManager};
