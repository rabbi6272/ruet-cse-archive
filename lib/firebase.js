...
import { getAuth, signInWithCustomToken, signOut, signInAnonymously } from "firebase/auth";
...
if (typeof window !== 'undefined') {
  ...
  try {
    ...
    // Enable anonymous authentication by default
    signInAnonymously(auth).catch((error) => {
      console.error("Anonymous auth error:", error);
    });
    
    console.log('🔥 Firebase initialized successfully with App Check');
