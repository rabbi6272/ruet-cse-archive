  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3
          className={`${nunito.className} mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200`}
        >
          {name}
        </h3>
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 text-center">{role}</p>
        ...
        <p className="mt-2 text-xs text-blue-500 dark:text-blue-400">Tap/Hover for social links</p>
