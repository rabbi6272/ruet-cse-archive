...
const ActiveUsersIndicator = ({ showDetails = false, className = "" }) => {
  ...
  if (loading) {
    return (
      <div
        className={`flex items-center gap-2 bg-gray-400 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg shadow-md ${className}`}
      >
  ...
  if (error) {
    return (
      <div
        className={`flex items-center gap-2 bg-red-500 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg shadow-md ${className}`}
      >
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div
        className={`flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3  py-2  rounded-lg shadow-md ${
          showDetails
            ? "cursor-pointer hover:from-green-600 hover:to-emerald-700"
            : ""
      ...
      {showDetails && showUsersList && (
        <>
          ...
          {/* Responsive Dropdown */}
          <div
            className="absolute top-full right-0 mt-2 w-72 sm:w-80 md:w-96 lg:w-80 xl:w-96 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 max-h-80 overflow-hidden 
              ...
              {activeUsers.length > 0 ? (
                <div className="divide-y divide-gray-100 dark:divide-gray-700">
                  {activeUsers.map((user) => (
                    <div
                      key={user.roll}
                      className="px-3 sm:px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors active:bg-gray-100 dark:active:bg-gray-600/50"
                    >
