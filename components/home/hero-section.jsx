...
export function HeroSection() {
  return (
    <div className={`${ibmPlexSans.className} hero-section w-full lg:max-w-4xl px-2 flex flex-col items-center mx-auto my-40 xl:my-34 text-center`}>
      <BlurText
        text="Welcome to RUET CSE Archive!"
        delay={50}
        animateBy="letters"
        direction="bottom"
        className="text-3xl md:text-4xl lg:text-5xl font-extrabold px-8 sm:px-0 mb-4 text-gray-600 dark:text-neutral-300"
      />
      <motion.p
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
