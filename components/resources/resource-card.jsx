...
export function ResourceCard({ id, title, description, image, links }) {
  return (
    <div className="resource-card flex flex-col mx-auto w-full h-[485px] max-w-full bg-white dark:bg-[#071a26] border border-gray-200 dark:border-gray-900 rounded-lg shadow-md">
      <Image
